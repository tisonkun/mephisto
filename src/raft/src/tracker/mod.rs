...
pub use self::{inflights::Inflights, progress::Progress, state::ProgressState};
use crate::{
    confchange::{MapChange, MapChangeType},
    eraftpb::ConfState,
    quorum::{AckedIndexer, Index, VoteResult},
    DefaultHashBuilder, HashMap, HashSet, JointConfig,
};
...
impl Configuration {
    ...
    pub fn to_conf_state(&self) -> ConfState {
        // Different from etcd, we don't sort.
        ConfState {
