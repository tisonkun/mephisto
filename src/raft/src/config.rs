...
pub struct Config {
    ...
    /// Note: [u64::MAX] for unlimited, 0 for at most one entry per message.
    ...
    /// Choose the linearizability mode or the lease mode to read data. If you don’t care about the
    /// read consistency and want a higher read performance, you can use the lease mode.
    ///
